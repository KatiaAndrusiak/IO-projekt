...
public class EmployeeAddController implements Initializable {
    ...
    public void addEmployee(ActionEvent e) {
        ...
        try {
            if(courseHoursSumAdd.getText().equals("")) {
                courseHoursSumAdd.setText("0");
            }
        ...
        employee.setCourseHoursSum(courseHoursSumAdd.getText().equals("") ? "0" : courseHoursSumAdd.getText());
